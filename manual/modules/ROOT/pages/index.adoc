...
Demonstration Plugin - May assist plugin developers to understand how to build OpenCPN 
plugins using the various plugin API's.

== 2. Install

image::demo_plugin-01.png

Once you have successfully compiled the plugin, download the plugin tarball from the repository. Install using the plugin manager. Tools→Plugins→Import plugin.
...
OpenCPN support libraries bundle a set of MEA 0183 libraries.
...
API using the observer listener model.
...
=== Chapter 13. wxWidgets Advanced User Interface
Chapter 14. Chart
